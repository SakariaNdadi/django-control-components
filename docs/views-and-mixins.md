...
### Composing Multiple Components on One Page

You can render tables, charts, stats, and forms together in a standard Django view (`TemplateView`) by passing `RenderContext` and rendering each component into template context:
